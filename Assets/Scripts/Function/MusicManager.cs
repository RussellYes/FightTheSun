...
public class MusicManager : MonoBehaviour
{
    ...
    private void OnSceneLoaded(Scene scene, LoadSceneMode mode)
    {
        ...
        if (scene.buildIndex < sceneMusicClips.Length && sceneMusicClips[scene.buildIndex] != null)
        {
            ...
            PlayMusic(currentSceneMusic, this.name);
        }
        else
        {
    ...
    public void PlayMusic(AudioClip musicClip, string sender)
    {
        if (musicClip == null)
        {
        ...
        musicSource.Play();
        Debug.Log($"MusicManager PlayMusic: {musicClip} from {sender}");
    }
    ...
    {
        Debug.Log($"MusicManager ResumeOriginalMusic - {originalClip}");
    ...
    {
        Debug.Log($"MusicManager StopMusic");
