...
public class MiningClawLauncher : MonoBehaviour
{
    ...
    {
        Debug.Log("MiningClawLauncher LaunchMiningClaw");
    ...
    {
        Debug.Log("MiningClawLauncher HandleClawDestroyed");
    ...
    {
        Debug.Log("MiningClawLauncher InitializeCable");
    ...
    {
        Debug.Log("MiningClawLauncher StopMiningClaw");
        if (currentClaw != null)
        {
            currentClaw.Retract();
        }
