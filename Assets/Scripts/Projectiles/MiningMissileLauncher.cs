...
public class MiningMissileLauncher : MonoBehaviour
{
    ...
    private void OnDataInitialized()
    {
        ...
        {
            missileCount = DataPersister.Instance.CurrentGameData.missileCount;
            launcherLevel = DataPersister.Instance.CurrentGameData.launcherLevel;
            isLauncherActive = DataPersister.Instance.CurrentGameData.launcherActive;
        }
        else 
        {
            missileCount = 0;
    ...
    private void SaveData()
    {
        if (DataPersister.Instance != null && DataPersister.Instance.CurrentGameData != null)
        {
            DataPersister.Instance.CurrentGameData.missileCount = missileCount;
            DataPersister.Instance.CurrentGameData.launcherLevel = launcherLevel;
            DataPersister.Instance.CurrentGameData.launcherActive = isLauncherActive;
        }
    }
    private void MissilePickUp(int amt, string missileType)
    {
