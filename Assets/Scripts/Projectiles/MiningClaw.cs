...
public class MiningClaw : MonoBehaviour
{
    ...
    private void Start()
    {
        Debug.Log("MiningClaw Start - spawned", this);
        ...
        if (clawCollider == null)
        {
            ...
            Debug.Log("MiningClaw Start - Added CircleCollider2D to MiningClaw", this);
        }
        ...
        if (rb == null)
        {
            ...
            Debug.Log("MiningClaw Start - Added Rigidbody2D to MiningClaw", this);
        }
    ...
    {
        Debug.Log("MiningClaw Initialize");
    ...
    private void Update()
    {
        ...
        {
            Debug.Log("MiningClaw Update - Mining target destroyed. Forcing retract.");
            Retract();
            return;
        }
        ...
        if (isMining)
        {
            ...
            OnClawTimerChanged?.Invoke(this, new OnClawTimerChangedEventArgs
            {
                ...
                timeRemaining = currentMiningTime,
    ...
    {
        Debug.Log("MiningClaw StartMining");
        isMining = true;
    ...
    {
        Debug.Log("MiningClaw CompleteMining");
    ...
    {
        Debug.Log("MiningClaw UpdateCable");
    ...
    {
        Debug.Log("MiningClaw ReturnToShip");
    ...
    {
        Debug.Log("MiningClaw OnDestroy");
