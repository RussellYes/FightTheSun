...
public class MiningUpgradeUI : MonoBehaviour
{
    ...
    private void OnInitializationComplete()
    {
        ...
        rareMetalToLauncherRateText.text = (rareMetalToLauncherRate * DataPersister.Instance.CurrentGameData.launcherLevel).ToString();
    ...
    private void UpdateTexts()
    {
        ...
        launcherText.text = DataPersister.Instance.CurrentGameData.launcherLevel.ToString();
    }
    ...
    {
        if (DataPersister.Instance.CurrentGameData.launcherLevel >= 4)
        {
            FailButtonSFX();
        ...
        if (DataPersister.Instance.CurrentGameData.totalRareMetal >= rareMetalToLauncherRate)
        {
            ...
            DataPersister.Instance.CurrentGameData.launcherLevel += tradeAmount;
            UpdateTexts();
