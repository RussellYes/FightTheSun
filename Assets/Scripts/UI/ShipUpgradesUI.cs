...
public class ShipUpgradesUI : MonoBehaviour
{
    ...
    [SerializeField] private TextMeshProUGUI engineeringButtonVisualCue;
    [SerializeField] private TextMeshProUGUI pilotingButtonVisualCue;
    [SerializeField] private TextMeshProUGUI mechanicsButtonVisualCue;
    [SerializeField] private TextMeshProUGUI miningButtonVisualCue;
    [SerializeField] private TextMeshProUGUI roboticsButtonVisualCue;
    [SerializeField] private TextMeshProUGUI combatButtonVisualCue;
    [SerializeField] private Color canBuyUpgradeTextColour;
    [SerializeField] private Color cantBuyUpgradeTextColour;
    ...
    [SerializeField] private TextMeshProUGUI engineeringCurrentAndPotentialSkillText;
    ...
    [SerializeField] private TextMeshProUGUI pilotingCurrentAndPotentialSkillText;
    ...
    [SerializeField] private TextMeshProUGUI mechanicCurrentAndPotentialSkillText;
    ...
    [SerializeField] private TextMeshProUGUI miningCurrentAndPotentialSkillText;
    ...
    [SerializeField] private TextMeshProUGUI roboticsCurrentAndPotentialSkillText;
    ...
    [SerializeField] private TextMeshProUGUI combatCurrentAndPotentialSkillText;
    ...
    public void UpdateMemoryAndSkillsText()
    {
        ...
        */
        ...
        UpdateSkillButtonState(engineeringButton, engineeringButtonVisualCue, engineeringMemoryCostText, engineeringMetalCostText, engineeringRareMetalCostText,
                              engineeringMemoryCost, engineeringMetalCost, engineeringRareMetalCost);

        UpdateSkillButtonState(pilotingButton, pilotingButtonVisualCue, pilotingMemoryCostText, pilotingMetalCostText, pilotingRareMetalCostText,
                              pilotingMemoryCost, pilotingMetalCost, pilotingRareMetalCost);

        UpdateSkillButtonState(mechanicsButton, mechanicsButtonVisualCue, mechanicsMemoryCostText, mechanicsMetalCostText, mechanicsRareMetalCostText,
                              mechanicsMemoryCost, mechanicsMetalCost, mechanicsRareMetalCost);

        UpdateSkillButtonState(miningButton, miningButtonVisualCue, miningMemoryCostText, miningMetalCostText, miningRareMetalCostText,
                              miningMemoryCost, miningMetalCost, miningRareMetalCost);

        UpdateSkillButtonState(roboticsButton, roboticsButtonVisualCue, roboticsMemoryCostText, roboticsMetalCostText, roboticsRareMetalCostText,
                              roboticsMemoryCost, roboticsMetalCost, roboticsRareMetalCost);

        UpdateSkillButtonState(combatButton, combatButtonVisualCue, combatMemoryCostText, combatMetalCostText, combatRareMetalCostText,
                              combatMemoryCost, combatMetalCost, combatRareMetalCost);
    }

    private void UpdateSkillButtonState(Button button, TextMeshProUGUI buttonVisualCue, TextMeshProUGUI memoryText, TextMeshProUGUI metalText, TextMeshProUGUI rareMetalText,
                                   float memoryCost, float metalCost, float rareMetalCost)
    {
        bool hasEnoughMemory = GetMemoryScore() >= memoryCost;
        bool hasEnoughMetal = GetMetalScore() >= metalCost;
        bool hasEnoughRareMetal = GetRareMetalScore() >= rareMetalCost;

        memoryText.color = hasEnoughMemory ? canBuyUpgradeTextColour : cantBuyUpgradeTextColour;
        metalText.color = hasEnoughMetal ? canBuyUpgradeTextColour : cantBuyUpgradeTextColour;
        rareMetalText.color = hasEnoughRareMetal ? canBuyUpgradeTextColour : cantBuyUpgradeTextColour;
        button.interactable = hasEnoughMemory && hasEnoughMetal && hasEnoughRareMetal;
        buttonVisualCue.color = button.interactable ? canBuyUpgradeButtonColour : cantBuyUpgradeButtonColour;
    }
